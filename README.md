...
- **주제: 여행 비용 정보 사이트** 
- **목적: 전세계 도시를 혼자 여행가는데 드는 비용을 직관적으로 보여줌**
...
- 지구본 위에 국제공항이 있는 도시들 핀으로 표시
- 도시별 최저가 1인 식비, 숙박비, 항공편 비용 계산
- 도시별 최소 여행비용 구간 기준 핀 색깔 구분 
- 외교부 여행경보 발령단계 정보 해당 도시별 표시

### 선택 기능

- 도시별 관광지 사진 또는 정보 표시
- 식비 숙박비 항공권 비용 선호도 기반 추천 서비스
- 무작위 도시 보여주는 버튼
